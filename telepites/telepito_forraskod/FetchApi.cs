    ...
    public class FetchApi
    {
        ...
        public string GetLatestPhpRelease() {
            ...
            if (match != null && match.Success) {
				...
				System.WriteLine("asdass " + this._phpRel);
                return this._phpRel;
            }
			System.WriteLine("asdass " + this._phpRel);
        ...
        public Uri GetLatestPhpVersionDownloadLink() {
            string pattern = "\"(php-" + this.GetLatestPhpVersion() + "-nts-Win32-vc15-x64.zip)\"";
            //if (!Environment.Is64BitOperatingSystem) pattern = "\"(php-" + this.GetLatestPhpVersion() + "-nts-Win32-vc15-x86.zip)\"";
        ...
        public Uri GetLatestXDebugDownloadLink() {
            ...
            string pattern = "(php_xdebug-[^-]+-" + this._phpRel + "-vc15-nts-x86_64.dll)";
            //if (!Environment.Is64BitOperatingSystem) pattern = "(php_xdebug-[^-]+-" + this._phpRel + "-vc15-nts.dll)";
            Regex regex = new Regex(pattern, RegexOptions.IgnoreCase);
